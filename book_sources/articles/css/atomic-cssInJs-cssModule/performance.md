...
由於 scss 等 css module 解決方案都是在 compile time 做靜態分析並將樣式編譯為 pure css，所以 run time 時候其實跟原生沒有太大區別。<br>
...
**在前端領域每天都有新技術出現，身為工程師應該要擁抱改變，而不是畏懼改變，畢竟世界需要我們走在前端:)**

到這邊，CSS Framework 系列文結束啦，我用了四篇文章談了 **_實作案例_**、**_開發者體驗_**、**_可擴展性_** 及 **_效能_** 的差異，希望有讓讀者更清楚要選擇哪一個框架來應對專案需求。
