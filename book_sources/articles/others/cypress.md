...
**注意**：如果你使用系統管理員下載，**可能會因為 User 不同而使用到不同的 npm config**，當然如果你專案底下有 `.npmrc` 可以避免這種問題，因為它的優先級會是最高的 (優先級可參考[這篇文章](https://stackoverflow.com/questions/51330735/npm-config-global-vs-local))。<br>
