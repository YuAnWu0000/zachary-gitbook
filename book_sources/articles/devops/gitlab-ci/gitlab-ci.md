...
還記得我第一次拼拼湊湊 CI/CD 的過程，自己看 pipeline log，自己進 container 偵錯，一行一行的撰寫 yml，最後當我在 Gitlab 看到那個打勾的圈圈，粗俗一點講，就像是三天便秘終於暢通的那種感覺，讓我瞬間體會到 DevOps 的魅力，如果可以，我也希望你自己動手試試看。
