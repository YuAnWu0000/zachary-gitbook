...
實作到這邊，理論上你應該已經完成了專案的 CI/CD，它會自動根據不同 branch 的 push commit 來幫你把專案部署到不同機器上。<br>
...
這份 CI 還有很多地方可以讓你擴充，這部分就留給讀者自己挖掘了 (例如串接自動化測試)。<br>

還記得我第一次拼拼湊湊 CI 的過程，自己看 pipeline log，自己進 container 偵錯，一行一行的撰寫 yml，最後當我在 Gitlab 看到那個打勾的圈圈，粗俗一點講，就像是三天便秘終於暢通的那種感覺，讓我瞬間體會到 DevOps 的魅力，如果可以，我也希望你可以自己動手試試看。
